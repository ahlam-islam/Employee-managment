        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <form action="handel/handelAssignTask.php?task_id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                        <input class="input--style-1" type="text" value="<?php echo $rows['task_name']; ?>"  name="taskname" disabled>
                        </div>

                        <div class="row row-space">
                            <div class="col-5">
                                <div class="input-group">
                                    <input class="input--style-1" type="date" value="<?php echo $rows['deadline']; ?>" name="duedate" required="required">
