...
<header>
    ...
    <a href="addEmployee.php" class="btn bg-primary text-white ">Add New Employess</a>
...
while($rows= $result->fetch_assoc())
{
  ?>
    ...
    <tr>
                ...
                <td><img src="<?php echo $rows['image'];  ?>" class="rounded-circal" width="50px" hight="50px"></td>
                <td> <?php echo $rows["name"];   ?> </td>
                <td> <?php echo $rows["email"];   ?> </td>
                <td> <?php echo $rows["password"];   ?> </td>
                <td> <?php echo $rows["phone"];   ?> </td>
                <td> <?php echo $rows["city"];   ?> </td>
                <td> <?php echo $rows["gander"];   ?> </td>
                <td> <?php echo $rows["birthday"];   ?> </td>
                <td><a href="DeleteEmp.php?task_id=<?php echo $rows['id']; ?>" class="bg-danger btn  text-white">Delete</a> </td>
